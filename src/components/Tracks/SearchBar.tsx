...
const SearchBar: React.FC<SearchBarProps> = ({setQuery, onTrackSearch}) => {
	return (
		...
		<div className="flex justify-between items-center bg-gray-12 h-16 border-2 border-white rounded-3xl p-6 my-14 text-lg">
			...
			<button onClick={onTrackSearch}>
				<img src="/assets/search_icon.png" alt="Search icon" className="w-8 h-8"/>
			</button>
		</div>
